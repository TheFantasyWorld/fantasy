...
public class ThreadPoolActivity extends BaseSwipeBackActivity  implements View.OnClickListener {
    ...
    private Button btn_thread1, btn_thread2, btn_thread3, btn_thread4, btn_thread5, btn_thread_all;
    private Button btn_stop1, btn_stop2, btn_stop3, btn_stop4, btn_stop5, btn_stop_all;
    private TextView tv_pool_type;
    private Button btn_shutdown, btn_shutdownNow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_thread3 = (Button) findViewById(R.id.btn_thread3);
        btn_thread4 = (Button) findViewById(R.id.btn_thread4);
        btn_thread5 = (Button) findViewById(R.id.btn_thread5);
        btn_thread_all = (Button) findViewById(R.id.btn_thread_all);
        ...
        btn_shutdownNow = (Button) findViewById(R.id.btn_shutdown_now);
    ...
    public void initEvents() {
        ...
        btn_thread5.setOnClickListener(this);
        btn_thread_all.setOnClickListener(this);
        ...
        btn_stop_all.setOnClickListener(this);
        btn_shutdown.setOnClickListener(this);
        btn_shutdownNow.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_thread_all:
                ...
                if (poolType == 0) {
                    //ScheduledThreadPool
                    ToastUtil.showMessage(mContext, "当前线程池是ScheduledThreadPool,延迟2秒后执行");
                } else if (poolType == 1) {
                    //SingleThreadExecutor
                    ToastUtil.showMessage(mContext, "当前线程池是SingleThreadExecutor");
                } else if (poolType == 2) {
                    //CachedThreadPool
                    ToastUtil.showMessage(mContext, "当前线程池是CachedThreadPool");
                } else if (poolType == 3) {
                    //FixedThreadPool
                    ToastUtil.showMessage(mContext, "当前线程池是FixedThreadPool");
                }
                break;
            case R.id.btn_stop1:
                stopThread(future1);
