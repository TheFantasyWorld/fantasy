...
public class ShareButtonView extends View {
    ...
    private static final String mTitleText = "分享";
    private static final String mButtonText = "确定";
    ...
    private void drawContentItem(Canvas canvas) {
        ...
        drawContentItemsText(canvas, "Qzone", "437", 1, mContentItemOnePaint);
        drawContentItemsText(canvas, "微信", "241", 2, mContentItemTwoPaint);
        drawContentItemsText(canvas, "新浪微博", "405", 3, mContentItemThreePaint);
    }
